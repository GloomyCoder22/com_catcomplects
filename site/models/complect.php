...
class CatcomplectsModelComplect extends JModelLegacy {
/*
...
*/
  ...
  public function getItemsComplect($item) {
    $db = JFactory::getDbo();
    $query = $db->getQuery(true);
    ...
    $query 
        ...
        ->where($db->quoteName('article').'='.$db->quote($item).' AND '.$db->quoteName('state').'=1');
