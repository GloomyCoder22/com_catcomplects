...
class CatcomplectsViewItems extends JViewLegacy {
  ...
  public function display($tpl = null) {
    ...
    CatcomplectsHelper::addSubmenu('items');
    $this->addToolbar();
  ...
  protected function addToolbar() {
    ...
    JToolBarHelper::title(JText::_('COM_CATCOMPLECTS_TITLE_ITEMS'), 'items.png');
    ...
    JHtmlSidebar::setAction('index.php?option=com_catcomplects&view=items');
